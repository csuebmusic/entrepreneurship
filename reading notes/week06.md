...
The segmentation argument. Kolb's premise is that creative entrepreneurs, convinced of their work's quality, assume everyone will want it, which is neither effective nor efficient. Consumers come in segments, groups who share what they want from a product, and the job is to target a segment rather than broadcast to all. He distinguishes market depth (finding more customers like the ones you already have, "fishing out of the same pond") from market breadth (attracting a new segment that is not yet buying, which needs its own message). He argues that segments are now more usefully grouped by psychographics (lifestyle, values, attitudes) than by demographics or geography, since social listening lets people with shared interests find each other online. The message is then tailored to the benefit each segment feels a shared need for. Box 5.1 (Allison Lyke) gives the blunt version: you may start by selling to friends, but that does not make them your target market.
...
key ideas: marketing as a value exchange; understanding the audience through what they get from the trade; market research as ongoing; learning from similar organizations. (The chapter's strategic-plan and digital-marketing sections belong to the later marketing weeks.)

## how they fit together

Kolb supplies the frame (segment and target, not everyone; depth versus breadth; psychographics). Landry and NYFA supply the method for drawing the profile itself: a specific composite of a real audience member, built from demographic and psychographic traits and the who/what/where/when/why/how of how they engage, with the shared warning that "everyone" is a trap and the shared reminder that the value people seek is often a feeling. Andrews supplies the why and the how of learning it: marketing is an exchange, so the profile has to capture what the audience gets from it, and market research is the ongoing practice that keeps the profile honest. Together they support the Audience Profile (who the audience is, what they value, where they are, and how they find work like yours), which is the first component of the marketing plan and serves outcomes 2 and 4. The reflection sets the audience the readings say you have against the one you imagine, and names what you do not yet know.
