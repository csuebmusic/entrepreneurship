...
The new anchor. Kolb opens on commoditization: when products are undifferentiated they compete on lowest price, and his point is that creative work is the exception, distinctive by design, so it competes on communicating value rather than on price (he notes customer experience has overtaken price and quality as the main differentiator). He sorts products into convenience, comparison, and specialty categories and places most artistic work in the specialty tier, where value comes partly from exclusivity and reputation. He covers product lines and portfolios (offerings that meet the same need form a line; small ventures should keep to one or two; extensions tend to work when they speak to lifestyle and identity, "purchased for the message it sends"). The core idea for this week is the core / actual / augmented model: a product is not the object but a bundle of benefits, a core benefit (the need it fills), the actual attributes (price, quality, size), and the augmented layer around it (service, delivery, the purchase experience).
...
Landry supplies the sharpest tool, the features-versus-benefits line: describe what the offering does for the buyer, not what it is. Kolb deepens it into the bundle-of-benefits model (core, actual, augmented) and reminds us that creative work sells on distinctiveness rather than price. NYFA sits earliest in the sequence, insisting you understand your own work before you frame it as an offering. Together they define the task: name what you offer and describe it as value to the audience you have profiled. That is the Product or Service Description (outcomes 2 and 4), which builds on the Audience Profile from week 6 and the Positioning Statement from week 7. The reflection has students name the several offerings a practice produces and say which one carries the most value for that audience.
