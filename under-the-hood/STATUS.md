...
- Week 1 to 11 module pages built (week01.html through week11.html) with reading notes; week 3 is the first async week. Week 11 opens Movement IV. Note: week10.html carries two em dashes, both inside McCurdy ch.4's real title "It's Not about the Money—Yet!" (a faithful citation, not prose). Week 5 uses two sourced, open-access outside readings (Goldin & Rouse 2000; Panic! 2018) alongside Rabideau 7.

## next

- Component guides: the HTML pages that teach each concept while doing the component. Fifteen of them.
- Weekly module pages: weeks 12 through 15 (weeks 1 to 11 done), each with the readings, the reflection, and the portfolio component.
