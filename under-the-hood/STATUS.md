...
- **Repeated chapters, verified against the books (Aug 10).** Four chapters are assigned in more than one week, and the outline gives the full chapter page range every time, so on paper a student is told to read the same pages two to four times. Checked section by section against the source texts:
  - *Landry ch. 2* (weeks 6, 8): genuinely different parts, no overlap. Week 6 wants "Defining Your Audiences" (pp. 29–37), week 8 wants "Products and Services" through "Designing and Creating Your Offering" (pp. 40–52). The citation is wrong, not the assignment. Cite the sub-ranges.
  - *NYFA ch. 11* (weeks 6, 7, 8, 11): four sections, and the assignment does not line up with them. §1 "Understanding Your Work and Your Place in the Market" goes to weeks 7 and 8 both; §2 "Understanding Your Audience" to week 6 alone; §4 "Branding" to weeks 7 and 11 both. §3 "Establishing Short- and Long-Term Goals," the largest section at 37% of the chapter and the one that teaches SMART marketing goals and timelines, is assigned nowhere. The digital edition has no printed folios, so cite by section name rather than page.
  - *Andrews ch. 3* (weeks 6, 7, 11): week 6 gets the Exchange Model and Market Research sections (pp. 70–72), week 7 gets the competitive-analysis part of Market Research (pp. 71–72), which sits inside week 6's. Week 11 gets "The Role of Marketing in Shaping Your Image" (pp. 68–69), distinct. Unassigned and relevant: "Strategic Marketing Plans" (pp. 77–81) and "Integrated Digital Marketing" (pp. 90–99).
  - *Landry ch. 1* (weeks 3, 7): week 3 wants the daydreaming, vision, and mission material (pp. 3–6, 13, 17–20); week 7 wants "Defining the UVP" (pp. 14–16), inside week 3's range. Split cleanly by sub-range.
  - Net: week 7 is the problem week. Its only genuinely new reading is Kolb ch. 3. Kolb, Rabideau, and McCurdy chapters are each assigned exactly once, so the repetition is confined to NYFA, Andrews, and Landry.
- **Reading load, once the sub-ranges are applied.** The nominal spread (110 pages in week 6 against 22 in week 8) is mostly a citation artifact. Cited by section, week 6 falls to roughly 40 pages, week 7 to 33, week 8 to 35, week 11 to 46. The remaining genuinely heavy weeks are 3 (92), 13 (82), and 9 (78).
