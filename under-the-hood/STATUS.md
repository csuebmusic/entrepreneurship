...
- Week 1 to 8 module pages built (week01.html through week08.html) with reading notes; week 3 is the first async week. Weeks 6 to 8 complete Movement II. Week 5 uses two sourced, open-access outside readings (Goldin & Rouse 2000; Panic! 2018) alongside Rabideau 7.

## next

- Component guides: the HTML pages that teach each concept while doing the component. Fifteen of them.
- Weekly module pages: weeks 9 through 15 (weeks 1 to 8 done), each with the readings, the reflection, and the portfolio component.
